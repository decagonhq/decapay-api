...
class CreateExpenseTest {
    ...
    void givenLineItemCreatedByUserExists_WhenUserLogExpenseAndTransactionDateIsBeforeStartDate_SystemShouldFailWith400() throws Exception {
        ...
        dto.setAmount(BigDecimal.valueOf(100));
        dto.setDescription("Food");
        dto.setTransactionDate(formatLocalDateToString(budgetStartDate.minusDays(1), DateConstants.DATE_INPUT_FORMAT));
        setAuthHeader(user);
    ...
    void givenLineItemCreatedByUserExists_WhenUserLogExpenseForPastBudgetAndTransactionDateOutsideBudgetDateRange_SystemShouldFailWith400() throws Exception {
        ...
        dto.setAmount(BigDecimal.valueOf(100));
        dto.setDescription("Food");
        dto.setTransactionDate(formatLocalDateToString(budgetEndDate.plusDays(1), DateConstants.DATE_INPUT_FORMAT));
        this.validateExpectation(budget, category, dto, status().isBadRequest());
    }
    ...
    void givenLineItemCreatedByUserExists_WhenUserLogExpense_SystemShouldLogExpenseSuccessfully() throws Exception {
        ...
        assertThat(expense1.getTransactionDate()).isEqualTo(formatStringToLocalDate(dto.getTransactionDate(), DateConstants.DATE_INPUT_FORMAT));
