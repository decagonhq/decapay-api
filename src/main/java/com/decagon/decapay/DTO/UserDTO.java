...
public class UserDTO {
	...
	@Schema(description = "First name, maximum 100 characters")
	private String firstName;

	@NotBlank
	@Size(min = 1, max = 100, message = "Last name field cannot be empty or more than 100 characters")
	@Schema(description = "Last name, maximum 100 characters")
	...
	@Schema(description = "Password, at least seven characters")
	private String password;

	@Pattern(regexp = "^\\d{7,15}$", message = "Phone number must be a valid number format")
	@Schema(description = "Phone number, all digits, at least seven and at most 15 characters")
